    ...
    public function run()
    {
        DB::table('SPK')->insert([
            ...
            [
                ...
                'parameter' => [
                    'kodemobil' => "ELF",
                    'modelbagasi' => "RANGKA LANTAI2",
                    'modelpintu' => "Pintu 4",
                    'modelbangku' => "bangku5",
                    'modelbody' => "body welding 2",
                    'modeltangga' => "tangga 3 tingkat",
                    'modellampubelakang' => "lampu belakang RH",
                    'newparameter' => [],
                ],
                'SPKactive' => true,
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ...
            [
                ...
                'parameter' => [
                    ...
                    'newparameter' => [
                        [
                            'newparam' => "BARU2",
                            'components' => ["BARU1", "BARU2"],
                        ],
                        [
                            'newparam' => "BARU1",
                            'components' => ["SASASA1", "SASASA2"],
                        ]
                    ]
                ],
                'SPKactive' => true,
