                ...
                <div class="row">
                    <div class="col-6" style="float: left;">
                        <div class="row">
                            ...
                            <div class="col-8">
                                <input type="text" v-model="parameter.kodemobil" class="form-control"></div>
                            </div>
                            <div class="row">
                                <div class="col">Model Bagasi</div>
                                <div class="col-8">
                                    <input type="text" v-model="parameter.modelbagasi[0]" class="form-control">
                                        <button type="button" :disabled='isActivebagasi' @click="add('modelbagasi')" class="btn btn-primary">Tambah</button>
                                        <button type="button" @click="remove('modelbagasi')" class="btn btn-danger">hapus tambahan</button>
                                        <div
                                            v-for="(component, index) in componentsbagasi"
                                            :key="index"
                                            :id=index
                                            tipe="modelbagasi">
                                            <div class="col-10">
                                                <input type="text" v-model="parameter.modelbagasi[index + 1]" required class="form-control"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <input type="text" v-model="parameter.modelpintu[0]" class="form-control">
                                                <button
                                                    :disabled='isActivepintu'
                                                    type="button"
                                                    @click="add('modelpintu')"
                                                    class="btn btn-primary">Tambah</button>
                                                <button type="button" @click="remove('modelpintu')" class="btn btn-danger">hapus tambahan</button>
                                                <component
                                                    v-for="(component, index) in componentspintu"
                                                    :key="index"
                                                    :id=index
                                                    tipe="modelpintu">
                                                    <div class="col-10">
                                                        <input type="text" v-model="parameter.modelpintu[index + 1]" required class="form-control"> </div>
                                                    </component>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    <input type="text" v-model="parameter.modelbangku[0]" class="form-control">
                                                        <button
                                                            type="button"
                                                            :disabled='isActivebangku'
                                                            @click="add('modelbangku')"
                                                            class="btn btn-primary ">Tambah</button>
                                                        <button type="button" @click="remove('modelbangku')" class="btn btn-danger">hapus tambahan</button>
                                                        <div
                                                            v-for="(component, index) in componentsbangku"
                                                            :key="index"
                                                            :id=index
                                                            tipe="modelbangku">
                                                            <div class="col-10">
                                                                <input type="text" v-model="parameter.modelbangku[index + 1]" required class="form-control"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-8">
                                                            <input type="text" v-model="parameter.modelbody[0]" class="form-control">
                                                                <button
                                                                    type="button"
                                                                    :disabled='isActivebody'
                                                                    @click="add('modelbody')"
                                                                    class="btn btn-primary">Tambah</button>
                                                                <button type="button" @click="remove('modelbody')" class="btn btn-danger">hapus tambahan</button>
                                                                <div
                                                                    v-for="(component, index) in componentsbody"
                                                                    :key="index"
                                                                    :id=index
                                                                    tipe="modelbody">
                                                                    <div class="col-10">
                                                                        <input type="text" v-model="parameter.modelbody[index + 1]" required class="form-control"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-8">
                                                                    <input type="text" v-model="parameter.modeltangga[0]" class="form-control">
                                                                        <button
                                                                            type="button"
                                                                            :disabled='isActivetangga'
                                                                            @click="add('modeltraptangga')"
                                                                            class="btn btn-primary">Tambah</button>
                                                                        <button type="button" @click="remove('modeltraptangga')" class="btn btn-danger">hapus tambahan</button>
                                                                        <div
                                                                            v-for="(component, index) in componentstraptangga"
                                                                            :key="index"
                                                                            :id=index
                                                                            tipe="modeltraptangga">
                                                                            <div class="col-10">
                                                                                <input type="text" v-model="parameter.modeltangga[index + 1]" required class="form-control"></div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class=" row">
                                                                        ...
                                                                        <div class="col-8">
                                                                            <input type="text" v-model="parameter.modellampubelakang[0]" class="form-control">
                                                                                <button
                                                                                    type="button"
                                                                                    :disabled='isActivelampu'
                                                                                    @click="add('modellampubelakang')"
                                                                                    class="btn btn-primary">Tambah</button>
                                                                                <button
                                                                                    type="button"
                                                                                    @click="remove('modellampubelakang')"
                                                                                    class="btn btn-danger">hapus tambahan</button>
                                                                                <div
                                                                                    v-for="(component, index) in componentlampubelakang"
                                                                                    :key="index"
                                                                                    :id=index
                                                                                    tipe="modellampubelakang">
                                                                                    <div class="col-10">
                                                                                        <input type="text" v-model="parameter.modellampubelakang[index + 1]" required class="form-control"></div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-8">
                                                                                    <input type="text" v-model="parameter.stall" class="form-control"></div>
                                                                                </div>
                                                                                <div class="row">
                                                                                    ...
                                                                                    <hr>
                                                                                        ...
                                                                                        <button
                                                                                            ...
                                                                                            class="btn btn-primary additionalbutton">Tambah Parameter</button>
                                                                                        <button
                                                                                            type="button"
                                                                                            @click="hapuskomponen()"
                                                                                            class="btn btn-primary additionalbutton">Hapus Komponen</button>
                                                                                        <div
                                                                                            v-for="(component, index) in parameter.newparameter"
                                                                                            :key="index"
                                                                                            :id=index>
                                                                                            <div class="row">
                                                                                                <div class="col">
                                                                                                    <input
                                                                                                        type="text"
                                                                                                        v-model="parameter.newparameter[index].newparam"
                                                                                                        class="newparam"></div>
                                                                                                    <div class="col-10">
                                                                                                        <input type="text" v-model="parameter.newparameter[index].components[0]">
                                                                                                            ...
                                                                                                            <button type="button" @click="removenewcomponen(index)" class="btn btn-danger">hapus tambahan</button>
                                                                                                            <div
                                                                                                                v-for="(component2, index2) in componentsnewparameter[index].components"
                                                                                                                :key="index2"
                                                                                                                :id=index2>
                                                                                                                <div class="col-10">
                                                                                                                    <input type="text" v-model="parameter.newparameter[index].components[index2 + 1]" class="form-control"></div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                ...
                                                                                                <div class="col-6" style=" float: right;">
                                                                                                    <div class="row">
                                                                                                        ...
                                                                                                        <div class="col-8">
                                                                                                            <input type="text" v-model="kit.namakit" class="form-control"></div>
                                                                                                        </div>
                                                                                                        <button type="button" @click="tambahresultkomponen()" class="btn btn-primary">Tambah Komponen</button>
                                                                                                        <br>
                                                                                                            ...
                                                                                                            <div v-for="(component, index) in kit.result" :key="index" :id=index>
                                                                                                                <div class="row">
                                                                                                                    <div class="col">Nama Komponen
                                                                                                                        <input
                                                                                                                            type="text"
                                                                                                                            v-model="kit.result[index].nama_komponen"
                                                                                                                            ...
                                                                                                                            <input type="number" v-model="kit.result[index].qty" class="numberinput">
                                                                                                                                ...
                                                                                                                                <input
                                                                                                                                    type="number"
                                                                                                                                    v-model="kit.result[index].darirak"
                                                                                                                                    class="numberinput"
                                                                                                                                    min="0">
                                                                                                                                    ke rak :
                                                                                                                                    <input
                                                                                                                                        type="number"
                                                                                                                                        v-model="kit.result[index].kerak"
                                                                                                                                        class="numberinput"
                                                                                                                                        min="0"></div>
                                                                                                                                </div>
                                                                                                                            </div>
